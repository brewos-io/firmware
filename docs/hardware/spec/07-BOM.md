...
| **1** | **U4** | **1.1V LDO**               | **TLV74311PDBVR** | **SOT-23-5** | **DVDD core voltage (external, replaces internal SMPS)** |
...
| **0** | **L2** | **REMOVED** | **-**      | **-**  | **-**   | **No longer needed (external LDO replaces internal SMPS)** |
